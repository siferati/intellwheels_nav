...
if __name__ == "__main__":
	...
	chair_trial_c1_x_t1_r1, chair_trial_c1_y_t1_r1 = get_data_from_csv('robot_two_robots_dqn_all_01_trajectory_robot1.csv')
	chair_trial_c2_x_t1_r2, chair_trial_c2_y_t1_r2 = get_data_from_csv('robot_two_robots_dqn_all_01_trajectory_robot2.csv')
 
 	chair_trial_c1_x_t2_r1, chair_trial_c1_y_t2_r1 = get_data_from_csv('robot_two_robots_dqn_all_02_trajectory_robot1.csv')
	chair_trial_c2_x_t2_r2, chair_trial_c2_y_t2_r2 = get_data_from_csv('robot_two_robots_dqn_all_02_trajectory_robot2.csv')

	chair_trial_c1_x_t3_r1, chair_trial_c1_y_t3_r1 = get_data_from_csv('robot_two_robots_dqn_all_03_trajectory_robot1.csv')
	chair_trial_c2_x_t3_r2, chair_trial_c2_y_t3_r2 = get_data_from_csv('robot_two_robots_dqn_all_03_trajectory_robot2.csv')
	...
	plt.xlabel('X (m)')
	plt.ylabel('Y (m)')
	plt.title('Trajectory of the chair (leader) and chair (follower) using DQN', fontsize = 10)
