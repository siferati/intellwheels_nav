...
from robot2.robot2_environment_stage_1 import Env
...
class ReinforceAgent():
    def __init__(self, state_size, action_size):
        ...
        self.dirPath = self.dirPath.replace('intellwheels_rl/src/robot2', 'intellwheels_rl/save_model/robot2_stage_1_')
